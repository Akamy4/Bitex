@extends('back.layout')
@section('content')
    @include('back.content-top', ['title' => 'Товар со страницы Корпоративным клиентам'])
        ...
        <div class="box-body">
            ...
            <div class="tab-content">
                ...
                <div id="panel2" class="tab-pane fade" style="padding-top: 10px">
                    ...
                    'title' => 'Изображение товара в каталоге (174x181 пикселей, в формате JPG/PNG)',
                    'field_name' => 'img'
                    ])

                    @include('back.tpls.checkbox', [
                    'title' => 'Отобразить в списке Хит продаж?',
                    'string' => 'Отображено',
                    'field_name' => 'show_on_hits',
                    ])

                    @include('back.tpls.text', [
                    'title' => 'Описание №1 в Хите продаж',
                    'field_name' => 'desc_1',
                    'br_replace' => true
                    ])

                    @include('back.tpls.string', [
                    'title' => 'Заголовок в хите продаж',
                    'field_name' => 'hit_title'
                    ])

                    @include('back.tpls.text', [
                    'title' => 'Описание №2 в Хите продаж',
                    'field_name' => 'desc_2',
                    'br_replace' => true
                    ])
                    
                    @include('back.tpls.string', [
                    'title' => 'Основной заголовок в карточке',
                    'field_name' => 'title'
                    ])

                    @include('back.tpls.text', [
                    'title' => 'Основное описание в карточке',
                    'field_name' => 'main_desc',
                    'br_replace' => true
                    ])
                    ...
                    @include('back.tpls.string', [
                    'title' => 'Минимальное количество товара',
                    ...
                    'title' => 'Список цветов',
                    'group_name' => 'c_products_colors_list',
