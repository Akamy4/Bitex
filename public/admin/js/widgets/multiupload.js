        ...
        if (options === undefined) {
            ...
            this.addPreview =  function( data ) {
                ...
                var _template = '<div class="file-preview-frame">'+
                    ...
                    '<img src="'+data.image+'" class="kv-preview-data file-preview-image" title="" alt="" style="width:auto;height:160px;">'+
                    '</div>'+
                    '<div class="file-thumbnail-footer">'+
                    '<div class="file-footer-caption" title=""><br><samp></samp></div>'+
